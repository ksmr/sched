...
int handle_EINVAL(JNIEnv * env)
{
    ...
    return (*env)->ThrowNew(env, null_pointer_exception_clazz,
            "The affinity bit mask contains no processors that are currently physically on the system and permitted to the thread.");
}
 ...
 * Signature: (J)V
 */
JNIEXPORT void JNICALL Java_net_ksmr_sched_Sched_linux_1sched_1setaffinity(JNIEnv *env, jclass clazz, jlong mask)
{
 ...
 * Signature: ([J)V
 */
JNIEXPORT void JNICALL Java_net_ksmr_sched_Sched_linux_1sched_1setaffinity_1dynamic(JNIEnv *env, jclass clazz, jlongArray mask)
{
 ...
 * Signature: ()J
 */
JNIEXPORT jlong JNICALL Java_net_ksmr_sched_Sched_linux_1sched_1getaffinity(JNIEnv *env, jclass clazz)
{
    cpu_set_t mask;
 ...
 * Signature: ()[J
 */
JNIEXPORT jlongArray JNICALL Java_net_ksmr_sched_Sched_linux_1sched_1getaffinity_1dynamic(JNIEnv *env, jclass clazz)
{
    int num_cpus = 512;
    int err;
    cpu_set_t *set;
